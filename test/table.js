...
describe('Table', () => {
  ...
  it('should not instantiate with wrong schema', async () => {
    const error = await catchError(Table.load, SOURCE, {schema: 'wrong schema'})
  ...
  it('should work with readable stream factory', async () => {
  ...
  it('should work with local path', async () => {
