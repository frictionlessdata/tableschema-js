...
const TESTS = [
  ...
  ['default', '10,000.00', 10000, {'groupChar': ',', 'currency': true}],
  ['default', '10,000,000.00', 10000000, {'groupChar': ',', 'currency': true}],
  ['default', '$10000.00', 10000, {'currency': true}],
  ['default', '  10,000.00 €', 10000, {'groupChar': ',', 'currency': true}],
  ['default', '10 000,00', 10000, {'groupChar': ' ', 'decimalChar': ','}],
  ['default', '10 000 000,00', 10000000, {'groupChar': ' ', 'decimalChar': ','}],
  // ['default', '10000,00 ₪', 10000, {'groupChar': ' ', 'decimalChar': ',', 'currency': true}],
  ['default', '  10 000,00 £', 10000, {'groupChar': ' ', 'decimalChar': ',', 'currency': true}],
